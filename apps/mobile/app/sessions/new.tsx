...
import { describeAgentAuthError, describeCursorHostError, describeRemoteError, formatRemoteError, humanizeRemoteError } from '@/device-link/remoteStatus';
      ...
      >
        <View style={styles.screen}>
          ...
          <View style={styles.bottomCluster}>
            ...
            {error ? (
              <Text style={styles.errorText}>{describeAgentAuthError(error) ?? describeCursorHostError(error, draft.agentKind) ?? describeRemoteError(error) ?? error}</Text>
            ) : null}
