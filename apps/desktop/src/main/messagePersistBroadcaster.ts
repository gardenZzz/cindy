 ...
 */
const dbAgentKindBySession = new Map<string, 'cc' | 'codex' | 'cursor' | 'pi'>();

export function noteSessionAgentKind(sessionId: string, dbAgentKind: 'cc' | 'codex' | 'cursor' | 'pi'): void {
  dbAgentKindBySession.set(sessionId, dbAgentKind);
}

export function getSessionDbAgentKind(sessionId: string): 'cc' | 'codex' | 'cursor' | 'pi' | null {
