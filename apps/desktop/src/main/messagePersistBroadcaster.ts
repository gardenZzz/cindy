 ...
 */
const dbAgentKindBySession = new Map<string, 'cc' | 'codex' | 'cursor'>();

export function noteSessionAgentKind(sessionId: string, dbAgentKind: 'cc' | 'codex' | 'cursor'): void {
  dbAgentKindBySession.set(sessionId, dbAgentKind);
}

export function getSessionDbAgentKind(sessionId: string): 'cc' | 'codex' | 'cursor' | null {
