...
export const subagentRuns = sqliteTable(
  'subagent_runs',
  {
    ...
    provider: text('provider', { enum: ['claude-code', 'codex', 'cursor', 'pi'] }).notNull(),
...
export const schedules = sqliteTable(
  'schedules',
  {
    ...
    agentKind: text('agent_kind', { enum: ['claude-code', 'codex', 'cursor', 'pi'] }).notNull(),
    model: text('model'),
    /**
...
export const dailyModelUsage = sqliteTable(
  'daily_model_usage',
  {
    ...
    day: text('day').notNull(),
    /** AgentKind ('claude-code' | 'codex' | 'cursor' | 'pi') — 网关模型 id 可能跨 agent 撞名, 需区分。 */
