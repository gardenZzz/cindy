...
type AvailableDefaultAgents = { has(vendor: 'cc' | 'codex' | 'pi'): boolean };

export async function readBotModelChainSettings(
  options?: { rootPath?: string; providers?: readonly ProviderView[]; availableAgents?: AvailableDefaultAgents },
