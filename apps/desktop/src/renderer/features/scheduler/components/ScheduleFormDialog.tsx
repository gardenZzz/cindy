...
export function ScheduleFormDialog({
  ...
  useEffect(() => {
    if (form.modelAgentKind || !currentModelEfforts.known || !form.effort) return;
                  ...
                  <div className="flex min-w-0 flex-1 items-center gap-0">
                    ...
                    <ModelEffortChip
                      onSelect={({ engine, modelId, providerId, effort, fast }) => selectModelConfiguration({
                        ...
                        model: modelId, providerId: providerId ?? '', effort: (effort ?? '') as typeof form.effort,
                        fastMode: fast,
                      })}
                      ...
                      onChangeFast={(v) => {
                        ...
                        if (form.model.trim()) setField('modelAgentKind', asModelAgentKind(form.agentKind));
                      }}
                    />
                  </div>
                  <button
